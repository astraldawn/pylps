'''
WIP, pending refactor into trees
'''
...
if    fire at T1
then deal_with_fire_1 from T2 to T3.

deal_with_fire_1    from T1 to T2
if deal_with_fire_2 from T1 to T2.

deal_with_fire_2    from T1 to T2
if deal_with_fire from T1 to T2.
